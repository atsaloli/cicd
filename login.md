...
31 Oct 2017
  ...
  At LISA 2017, I taught the class "Setting up CI/CD Pipelines".
I found while many conference attendees already had some
exposure or even expertise in the area, some did not know what
CI/CD stands for.

  The purpose of this article is to introduce the subject and
to define all its basic terms.

  First of all, "CI" stands for "Continous Integration".
Let's take a look at what those words mean by themselves,
...
That's Twiddle-dum. Twiddle-dee is "CD", and that stands for "Continuous Deployment"
